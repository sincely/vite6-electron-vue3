...
export default [
  ...
  },
  {
    ...
    type: 'handle',
    handler: () => {
      const rawCommit = typeof __COMMIT_HASH__ !== 'undefined' ? __COMMIT_HASH__ : 'unknown'
      const commitHash = rawCommit && rawCommit !== 'unknown' ? String(rawCommit).slice(0, 7) : rawCommit
