declare global {
  const MOCK_PRODUCTS: typeof import('../../utils/mock-data').MOCK_PRODUCTS
  const MOCK_USERS: typeof import('../../utils/mock-data').MOCK_USERS
  const allUsers: typeof import('../../utils/table-data').allUsers
  ...
  const cachedEventHandler: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache').cachedEventHandler
  const cachedFunction: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache').cachedFunction
  ...
  const clone: typeof import('../../utils/system-data').clone
  ...
  const createNextId: typeof import('../../utils/system-data').createNextId
  ...
  const defineCachedEventHandler: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache').defineCachedEventHandler
  const defineCachedFunction: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/cache').defineCachedFunction
  ...
  const defineNitroErrorHandler: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/error/utils').defineNitroErrorHandler
  const defineNitroPlugin: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/plugin').defineNitroPlugin
  ...
  const defineRenderHandler: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/renderer').defineRenderHandler
  ...
  const defineRouteMeta: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/meta').defineRouteMeta
  const defineTask: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/task').defineTask
  ...
  const findMenuNode: typeof import('../../utils/system-data').findMenuNode
  const flattenMenus: typeof import('../../utils/system-data').flattenMenus
  ...
  const getRouteRules: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/route-rules').getRouteRules
  ...
  const includesText: typeof import('../../utils/system-data').includesText
  ...
  const menuTree: typeof import('../../utils/system-data').menuTree
  const nitroPlugin: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/plugin').nitroPlugin
  const normalizeText: typeof import('../../utils/system-data').normalizeText
  const paginate: typeof import('../../utils/system-data').paginate
  ...
  const permissionOptions: typeof import('../../utils/system-data').permissionOptions
  ...
  const removeMenuNode: typeof import('../../utils/system-data').removeMenuNode
  const removeResponseHeader: typeof import('../../../../node_modules/.pnpm/h3@1.15.11/node_modules/h3').removeResponseHeader
  const roleList: typeof import('../../utils/system-data').roleList
  const roleNames: typeof import('../../utils/system-data').roleNames
  const runTask: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/task').runTask
  ...
  const setRoleList: typeof import('../../utils/system-data').setRoleList
  const setUserList: typeof import('../../utils/system-data').setUserList
  ...
  const updateMenuNode: typeof import('../../utils/system-data').updateMenuNode
  const updateSession: typeof import('../../../../node_modules/.pnpm/h3@1.15.11/node_modules/h3').updateSession
  const useAppConfig: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/config').useAppConfig
  const useBase: typeof import('../../../../node_modules/.pnpm/h3@1.15.11/node_modules/h3').useBase
  const useEvent: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/context').useEvent
  const useNitroApp: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/app').useNitroApp
  ...
  const useRuntimeConfig: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/config').useRuntimeConfig
  const useSession: typeof import('../../../../node_modules/.pnpm/h3@1.15.11/node_modules/h3').useSession
  const useStorage: typeof import('../../../../node_modules/.pnpm/nitropack@2.11.12_@netlify+blobs@9.1.2_@parcel+watcher@2.5.6_encoding@0.1.13/node_modules/nitropack/dist/runtime/internal/storage').useStorage
  const userList: typeof import('../../utils/system-data').userList
  const userStats: typeof import('../../utils/table-data').userStats
...
export { clearRefreshTokenCookie, setRefreshTokenCookie, getRefreshTokenFromCookie } from 'D:/project/vite6-electron-vue3/apps/backend/utils/cookie-utils';
export { generateAccessToken, generateRefreshToken, verifyAccessToken, verifyRefreshToken } from 'D:/project/vite6-electron-vue3/apps/backend/utils/jwt-utils';
export { MOCK_USERS, MOCK_PRODUCTS } from 'D:/project/vite6-electron-vue3/apps/backend/utils/mock-data';
export { useResponseSuccess, usePageResponseSuccess, useResponseError, forbiddenResponse, unAuthorizedResponse, sleep, pagination } from 'D:/project/vite6-electron-vue3/apps/backend/utils/response';
export { roleNames, permissionOptions, userList, roleList, menuTree, setUserList, setRoleList, clone, normalizeText, includesText, paginate, flattenMenus, findMenuNode, updateMenuNode, removeMenuNode, createNextId } from 'D:/project/vite6-electron-vue3/apps/backend/utils/system-data';
export { allUsers, userStats } from 'D:/project/vite6-electron-vue3/apps/backend/utils/table-data';